...
int8_t rx1DrOffsetArray[] = {0, 1, 2, 3, 4, 5, -1, -2};
...
typedef union
{
    ...
    {
        unsigned maxEirp:4;
        unsigned uplinkDwellTime:1;
        unsigned downlinkDwellTime:1;
        unsigned rfu:2;
    };
} EirpDwellTime_t;

uint8_t maxEirpValueEncoded;
uint8_t maxEirpValue;
...
uint8_t dlChannelReqAnsFlag = 0;
uint8_t rxParamSetupAns = 0;
uint8_t dlChannelCurrentIndex = 0;
uint8_t dlChannelAns[8] = {0, 0, 0, 0, 0, 0, 0, 0};
