...
dist/${CND_CONF}/${IMAGE_TYPE}/RN2903_Parser.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/RN2903_Parser.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=realice  --double=24 --float=24 --emi=wordwrite --rom=default,300-ffff --opt=+asm,-asmfile,+speed,-space,-debug,-local --addrqual=ignore --mode=pro -P -N255 -I"system" -I"parser" -I"mcc_generated_files" -I"mcc_generated_files/LoRaWAN" --warn=0 --asmlist -DXPRJ_combined=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --fill=0xffff@0x0300:0xffff --codeoffset=0300 --checksum=0300-FFFD@FFFE,width=-2,algorithm=2 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s" --MSGDISABLE=1090:off;        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/RN2903_Parser.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
...
dist/${CND_CONF}/${IMAGE_TYPE}/RN2903_Parser.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    ../../Bootloader/CheckSum/LoRaBtCs.X/dist/default/production/LoRaBtCs.X.production.hex
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/RN2903_Parser.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --rom=default,300-ffff --opt=+asm,-asmfile,+speed,-space,-debug,-local --addrqual=ignore --mode=pro -P -N255 -I"system" -I"parser" -I"mcc_generated_files" -I"mcc_generated_files/LoRaWAN" --warn=0 --asmlist -DXPRJ_combined=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --fill=0xffff@0x0300:0xffff --codeoffset=0300 --checksum=0300-FFFD@FFFE,width=-2,algorithm=2 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s" --MSGDISABLE=1090:off;     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/RN2903_Parser.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	
	@echo "Creating unified hex file"
	@"C:/Program Files (x86)/Microchip/MPLABX/v3.51/mplab_ide/platform/../mplab_ide/modules/../../bin/hexmate" --edf="C:/Program Files (x86)/Microchip/MPLABX/v3.51/mplab_ide/platform/../mplab_ide/modules/../../dat/en_msgs.txt" dist/${CND_CONF}/${IMAGE_TYPE}/RN2903_Parser.${IMAGE_TYPE}.hex ../../Bootloader/CheckSum/LoRaBtCs.X/dist/default/production/LoRaBtCs.X.production.hex -odist/${CND_CONF}/production/RN2903_Parser.production.unified.hex
