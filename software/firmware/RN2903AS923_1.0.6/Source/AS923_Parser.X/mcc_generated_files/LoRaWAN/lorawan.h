...
#define ISM_BAND_ASIA_DEFAULT    ISM_AS923_HONG_KONG //TODO: custom freemaker must be added here to reflect user's choise of ISM band
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned uplinkDwellTimeFlag :1;             //if set, the uplink dwell time is enabled
        unsigned downlinkDwellTimeFlag :1;           //if set, the downlink dwell time is enabled
    };
} LorawanStatus_t;
